...
7. Mapowanie widoków na dostępne endpointy API w celu synchronizacji danych.
8. Implementacja mechanizmów obsługi błędów i wyświetlania komunikatów zgodnych z formatem API.
9. Wykorzystanie spójnych komponentów interfejsu (np. Shadcn/ui) dla jednolitego doświadczenia użytkownika.
10. Zapewnienie intuicyjnej nawigacji umożliwiającej łatwy powrót do głównych widoków po zakończeniu operacji.  
    </matched_recommendations>
